...
var CategoryItemHighlightLayer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryItemHighlightLayer.prototype.get_dc = function () {
        return true;
    };
    CategoryItemHighlightLayer.prototype.by = function () {
        return new CategoryItemHighlightLayerView(this);
    };
    CategoryItemHighlightLayer.prototype.l4 = function (a) {
        _super.prototype.l4.call(this, a);
        this.tb = a;
    };
    CategoryItemHighlightLayer.prototype.r3 = function (a, b) {
        if (this.tf == null || this.tf == a) {
            if (!this.at.c) {
                this.mn(b);
            }
        }
    };
    CategoryItemHighlightLayer.prototype.qw = function (a) {
        if (!_super.prototype.qw.call(this, a)) {
            return false;
        }
        if (this.tt != null) {
            if (a.dx) {
                var b = a.ju();
                if (!Base.equalsStatic(this.tt, b)) {
                    return false;
                }
            }
            else {
                if (!Base.equalsStatic(this.tt, a.name)) {
                    return false;
                }
            }
        }
    ...
    CategoryItemHighlightLayer.prototype.r5 = function (a, b) {
        var e_1, _a;
        var _this = this;
    ...
    CategoryItemHighlightLayer.prototype.l9 = function (a, b, c, d) {
    ...
    CategoryItemHighlightLayer.prototype.tz = function (a, b, c) {
        if (this.b1 == null || this.b1.bv.isEmpty || this.b1.bu.isEmpty) {
            return;
        }
        if (!a.dj && !a.ds) {
            return;
        ...
        if (k) {
            ...
            var o = a.ps(l.d, this.tj, g);
            var p = void 0;
            var q = this.getEffectiveViewport1(this.b1);
            if (a.isVertical) {
                var r = o.y;
                ...
                p = new Rect(0, this.p7.left, r - t / 2, this.p7.width, t);
            }
            else {
                var u = o.x;
                ...
                p = new Rect(0, u - w / 2, this.p7.top, w, this.p7.height);
            }
            p.intersect(this.b1.bu);
            this.ty(p, b, a);
        }
    };
    CategoryItemHighlightLayer.prototype.tx = function (a, b, c) {
        ...
        d.g = this.td(c, a);
        var e = (typeCast(MarkerSeries.$, c) !== null) ? c.q5 : null;
        if (e == null || e == MarkerSeries.q8 || (this.te != 2 && this.te != 0)) {
            var f = MarkerSeries.qm(c, 2);
            if (this.te != 2 && this.te != 0) {
                f = this.te;
            }
            switch (f) {
                case 3:
        ...
        d.h = this.t2 != null ? this.t2 : e;
        if (!isNaN_(d.b) && !isNaN_(d.e)) {
            b.g.addItem(d.f, d);
        }
    };
    CategoryItemHighlightLayer.prototype.td = function (a, b) {
        var c = a.hy(b);
        var d = a.f9(b);
        if (this.tj && d != Math.floor(d)) {
            c = null;
        }
        return ((function () {
    ...
    CategoryItemHighlightLayer.prototype.ty = function (a, b, c) {
        var d = new ItemHighlightFrameRect();
        d.b = a.left;
        d.e = a.top;
        d.c = a.right;
    ...
    CategoryItemHighlightLayer.prototype.r8 = function (a, b) {
        var e_2, _a;
    ...
    CategoryItemHighlightLayer.prototype.t0 = function (a, b) {
        ...
        var d = a.g;
        d.itemBrush = a.i;
        var e = d.series.ps(c, this.cw() || this.th, this.tg);
        if (isNaN_(e.x) || isNaN_(e.y)) {
            b._visibility = 1;
            return;
        }
        this.tb.cc(b, e.x, e.y);
        b.ah = a.h;
        b.content = a.g;
    };
    CategoryItemHighlightLayer.prototype.t1 = function (a, b) {
        if (isNaN_(a.b) || isNaN_(a.e) || isNaN_(a.a) || isNaN_(a.c) || isNaN_(a.d)) {
            b._visibility = 1;
            return;
        }
        this.tb.cd(b, a.b, a.e, a.c - a.b, a.a - a.e);
        b._fill = a.i;
        b._stroke = a.j;
        b.ad = a.d;
        if (this.pi != null) {
    ...
    CategoryItemHighlightLayer.prototype.ep = function () {
        return true;
    };
    CategoryItemHighlightLayer.$t = markType(CategoryItemHighlightLayer, 'CategoryItemHighlightLayer', AnnotationLayer.$);
    CategoryItemHighlightLayer.$$p = markDep(DependencyProperty, PropertyMetadata, CategoryItemHighlightLayer, 'raisePropertyChanged', ['BandHighlightWidth:tl:t3', [1, 10], 'HighlightType:tc:t4', [CategoryItemHighlightType_$type, enumGetBox(CategoryItemHighlightType_$type, 0)], 'MarkerBrush:ud:t5', [Brush.$, null], 'MarkerOutline:ue:t6', [Brush.$, null], 'MarkerTemplate:t2:t7', [DataTemplate.$, null], 'MarkerType:te:t8', [MarkerType_$type, enumGetBox(MarkerType_$type, 2)], 'SkipUnknownValues:ti:t9', [0, true], 'TargetSeriesName:tt:ua', [2, null], 'TargetSeries:tf:ub', [Series.$, null], 'UseInterpolation:tj:uc', [0, false]]);
...
var CategoryItemHighlightLayerView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryItemHighlightLayerView.prototype.al = function (a) {
        ...
        for (var b = 0; b < this.b8.count; b++) {
            this.e.a9.exportRectangleData(a, this.b8._inner[b], "catItemRect", ["Main", "CategoryItem"]);
        }
        for (var c = 0; c < this.b7.count; c++) {
            this.e.a9.exportMarkerVisualDataFromMarker(this.e, a, this.b7._inner[c]);
        }
    };
