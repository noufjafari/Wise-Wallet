...
var TimeXAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TimeXAxis.prototype.ov = function () {
        ...
        var b = this.bh.ta;
        var c = new ScalerParams(0, this.bh.ta, this.bh.tp, this.cg, this.bh.te);
    ...
    TimeXAxis.prototype.nh = function () {
        ...
        var a = new ScalerParams(0, this.bh.ta, this.bh.tp, this.cg, this.bh.te);
        var b = this.j6();
        var c = b.left;
        var d = b.right;
        var e = b.left;
    ...
    TimeXAxis.prototype.i$f = function (a) {
        ...
        var i = c.item(g);
        var j = c.item(h);
        var k = new ScalerParams(0, this.bh.tq, this.kc, this.cg, this.bh.te);
        this.startCursor();
    ...
    TimeXAxis.prototype.getCategorySize = function (a, b, c) {
        if (this.ou != (0)) {
            var d = timeSpanFromTicks(truncate((timeSpanTicks(this.ou) * (a.width / (this.bh != null ? this.bh.ta.width : 1)))));
