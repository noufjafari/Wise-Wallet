...
var RadialColumnSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialColumnSeries.prototype.get_dk = function () {
        return true;
    };
    RadialColumnSeries.prototype.get_d5 = function () {
        return true;
    };
    RadialColumnSeries.prototype.gz = function () {
        if (!isNaN_(this.gy)) {
            return _super.prototype.gz.call(this);
        }
        return Defaults.h;
    };
    RadialColumnSeries.prototype.by = function () {
        return new RadialColumnSeriesView(this);
    };
    RadialColumnSeries.prototype.l4 = function (a) {
    ...
    RadialColumnSeries.prototype.l9 = function (a, b, c, d) {
    ...
    RadialColumnSeries.prototype.preferredCategoryMode = function (a) {
        return a != null && a == this.rt ? 2 : 0;
    };
    RadialColumnSeries.prototype.k2 = function (a, b) {
    ...
    RadialColumnSeries.prototype.get_c3 = function () {
        return true;
    };
    RadialColumnSeries.prototype.ge = function () {
        return this.rt.k3(this.b1.bv, this.b1.bu, this.getEffectiveViewport1(this.b1));
    };
    RadialColumnSeries.prototype.sy = function (a, b) {
        ...
        var g = this.pz(b);
        var h = this.r0.k0(e, d, f, g);
        var i = b;
        var j = this.r0;
        var k = Math.max(0, 0.5 * j.nm);
        k = Math.max(k, h.minLength * 0.9);
        var l = ViewportUtils.d(k, d, e);
        var m = this.rt.k3(d, e, f);
        var n = Math.max(0.1 * this.r0.nn, k);
        var o = this.r1.d(0, n, d, e);
        var p = this.r1.e(0, n, d, e);
        var q = this.r1.d(m, n, d, e);
        var r = this.r1.e(m, n, d, e);
        ...
        for (var z = 0; z < c.count; ++z) {
            ...
            var ab = this.r1.d(a.f._inner[z][0], aa, d, e);
            var ac = this.r1.e(a.f._inner[z][0], aa, d, e);
            var ad = Math.sqrt((ab - t.x) * (ab - t.x) + (ac - t.y) * (ac - t.y));
            var ae = ad;
            var af = l;
            if (v) {
                this.tx(c, z, u, x, y, b.q);
            }
            var ag = this.r7.k;
            var ah = this.r7.l;
            ...
            au.c.add(av);
            aj.an = au;
            this.r7.ad(aj, false, false, false, false);
        }
        i.c1.count = c.count;
        this.uf.c6();
    };
    RadialColumnSeries.$t = markType(RadialColumnSeries, 'RadialColumnSeries', AnchoredRadialSeries.$);
    RadialColumnSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialColumnSeries, 'raisePropertyChanged', ['RadiusX:ug:uk', [1, 0], 'RadiusY:uh:ul', [1, 0]]);
...
var RadialColumnSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialColumnSeriesView.prototype.as = function () {
        ...
        if (!this.q) {
            this.cr.ql = Defaults.c;
            this.cr.g4 = Defaults.i;
        }
    };
    ...
    RadialColumnSeriesView.prototype.al = function (a) {
        ...
        try {
            for (var _b = __values(fromEnum(this.c1.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
                this.e.a9.exportPathData(a, c, "column" + b, ["Main", "Fill"]);
                b++;
            }
        }
        catch (e_1_1) {
