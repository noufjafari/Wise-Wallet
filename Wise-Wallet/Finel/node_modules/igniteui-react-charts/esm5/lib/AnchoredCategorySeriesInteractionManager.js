...
var AnchoredCategorySeriesInteractionManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$b = function (a, b, c, d, e, f, g, h) {
        ...
        var i = truncate(Math.round(a.f9(b)));
        if (i < 0 || i >= a.cl.count) {
            return h(b);
        }
        var j = intDivide(i, c);
        ...
        var m = a.pz(a.b1);
        var n = new ScalerParams(0, a.ce.tq, a.ce.tp, f.cg, a.ce.te);
        var o = m.top;
        var p = m.bottom;
        var q = o + (p - o) * b.y;
        var r = f.el(q, n);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$a = function (a, b, c, d, e, f) {
        ...
        var j = !g.isEmpty && !h.isEmpty && a.cl != null ? a.cl.indexOf(f) : -1;
        var k = a.p1(a.b1);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$d = function (a, b, c, d, e, f, g, h) {
        ...
        var j = a.b1.bv;
        var k = a.b1.bu;
        var l = a.getEffectiveViewport1(a.b1);
        var m = new ScalerParams(0, j, k, d.cg, l);
        m.b = a.gg();
        var n = a.aj(a.as(), e.f, f, g, b, true);
        if (n == null) {
            return Rect.empty;
        }
        var o = n[0];
