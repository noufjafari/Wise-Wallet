...
var NumericYAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    NumericYAxis.prototype.nz = function (a, b) {
        if (this.bh == null || isNaN_(a) || isNaN_(b)) {
            return;
        }
        var c = this.nn(a, this);
        var d = this.nn(b, this);
        if (isNaN_(c) || isNaN_(d)) {
            return;
        }
        this.bh.tq = new Rect(0, this.bh.tq.x, d, this.bh.tq.width, c - d);
    };
    NumericYAxis.prototype.kx = function () {
        var _this = this;
    ...
    NumericYAxis.prototype.k0 = function (a, b, c, d) {
        var e = d;
        var f = _super.prototype.k0.call(this, a, b, c, d);
