...
import { fromDoubleCollection, toDoubleCollection, brushToString, stringToBrush, toPoint, fromPoint, fromRect, stringToColor, colorToString, ensureEnum, ensureBool, isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core";
...
var IgrSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    */
    ...
    Object.defineProperty(IgrSeries.prototype, "isAnnotationValueLayer", {
        /**
    ...
    Object.defineProperty(IgrSeries.prototype, "legendItemVisibility", {
        ...
        */
        ...
        set: function (v) {
            this.i.qb = ensureEnum(Visibility_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeries.prototype, "legendItemBadgeMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.ba = ensureEnum(LegendItemBadgeMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeries.prototype, "lineJoin", {
        /**
        ...
        */
        ...
        set: function (v) {
            this.i.pl = ensureEnum(PenLineJoin_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeries.prototype, "dashArray", {
        /**
         * Gets or sets a collection of Double values that indicate the pattern of dashes and gaps that
         * is used to outline the current series object.
        */
        get: function () {
            return fromDoubleCollection(this.i.pi);
        },
        set: function (v) {
            this.i.pi = toDoubleCollection(v);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(IgrSeries.prototype, "actualHighlightingMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.bl = ensureEnum(SeriesHighlightingMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeries.prototype, "visibleRangeMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.b5 = ensureEnum(SeriesVisibleRangeMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(IgrSeries.prototype, "outlineMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.bu = ensureEnum(SeriesOutlineMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeries.prototype, "transitionInSpeedType", {
        ...
        */
        ...
        set: function (v) {
            this.i.cb = ensureEnum(TransitionInSpeedType_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(IgrSeries.prototype, "lineCap", {
        /**
        ...
        */
        ...
        set: function (v) {
            this.i.pk = ensureEnum(PenLineCap_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeries.prototype, "hitTestMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.br = ensureEnum(SeriesHitTestMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
...
*/
    ...
    */
    IgrSeries.prototype.getItemIndex = function (world) {
        var iv = this.i.hi(toPoint(world));
        return (iv);
    };
    /**
    ...
    */
    IgrSeries.prototype.getSeriesValueType = function (mode) {
        var iv = this.i.am((mode == null ? null : mode));
        return (iv);
    };
    IgrSeries.prototype.getSeriesValueTypePosition = function (mode) {
        var iv = this.i.pv((mode == null ? null : mode));
        return fromPoint(iv);
    };
    IgrSeries.prototype.getSeriesValueTypePositionFromValue = function (values) {
        var iv = this.i.pw(values);
        return fromPoint(iv);
    };
    /**
    ...
    */
    IgrSeries.prototype.toWorldPosition = function (seriesPoint) {
        var iv = this.i.px(toPoint(seriesPoint));
        return fromPoint(iv);
    };
    /**
    ...
    */
    IgrSeries.prototype.fromWorldPosition = function (world) {
        var iv = this.i.pn(toPoint(world));
        return fromPoint(iv);
    };
    /**
