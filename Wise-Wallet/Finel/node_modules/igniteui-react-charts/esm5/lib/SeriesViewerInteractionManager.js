...
var SeriesViewerInteractionManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesViewerInteractionManager.prototype.f$ao = function (a, b) {
        ...
        e = a.cu.e();
        var f;
        var g = ((function () { var h = a.cu.f(b, false, f, false); f = h.p2; return h.ret; })());
        if (g != e) {
            if (e != null && e.a7.a$c) {
    ...
    SeriesViewerInteractionManager.prototype.f$an = function (a) {
        ...
        a.md(c);
        var k = a.cl == 0 && !a.eb && (a.dz || f) && !g && !h;
        var l = a.tp;
        if (k && !isNaN_(b.x) && !l.isEmpty) {
            var m = l.width * (b.x - a.ta.left) / a.ta.width;
        ...
        if (k && !isNaN_(b.y) && !l.isEmpty) {
            var n = l.height * (b.y - a.ta.top) / a.ta.height;
    ...
    SeriesViewerInteractionManager.prototype.f$f = function (a, b, c) {
        var d = a.cu;
        var e = a.ta;
        var f = e.left + e.width * b.x / a.tp.width;
        var g = e.top + e.height * b.y / a.tp.height;
    ...
    SeriesViewerInteractionManager.prototype.f$o = function (a, b) {
        var c = a.ta;
        var d = c.left + c.width * b.x / a.tp.width;
        var e = c.top + c.height * b.y / a.tp.height;
        var f = 0.7;
    ...
    SeriesViewerInteractionManager.prototype.f$d = function (a, b, c, d, e, f, g) {
        ...
        if (w != null) {
            var ab = w.au({ $type: Point_$type, x: l, y: m }, g);
            if (ab != null) {
                f = ab;
            }
            return {
    ...
    SeriesViewerInteractionManager.prototype.f$x = function (a, b, c) {
        var d;
        var e = (this.d != null) ? this.d : ((function () { var f = a.cu.f(c, false, d, false); d = f.p2; return f.ret; })());
        if (e != null) {
