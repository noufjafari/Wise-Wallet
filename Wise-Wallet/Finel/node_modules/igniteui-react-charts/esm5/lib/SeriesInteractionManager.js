...
var SeriesInteractionManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SeriesInteractionManager.prototype.a$m = function (a, b, c, d, e, f, g, h, i) {
        ...
        var j = a.fc;
        var k = a.hp(c, i, d, g, b);
        var l = a.hn(c, i, d, g, b);
        var m = a.f7(c, k, d, e, f);
        var n = a.f7(c, l, d, e, f);
        var o = k;
        var p = l;
        var q = d.cm;
        if (q && !j) {
    ...
    SeriesInteractionManager.prototype.a$d = function (a, b, c) {
        ...
        for (var f = 0; f < d.length; f++) {
            ...
            if (GeometryUtil.a(b, g[0], g[1], a.fy / 2 + a.gc(c))) {
                return true;
            }
            if (e != null && f < e.length) {
                ...
                if (GeometryUtil.a(b, h[0], h[1], a.fy / 2 + a.gc(c))) {
                    return true;
                }
                if (GeometryUtil.a(b, g[0], h[0], a.fy / 2 + a.gc(c))) {
                    return true;
                }
                if (GeometryUtil.a(b, g[1], h[1], a.fy / 2 + a.gc(c))) {
                    return true;
                }
                var i = new Array(5);
                i[0] = h[0];
    ...
    SeriesInteractionManager.prototype.a$e = function (a, b, c, d) {
        ...
        for (var e = 0; e < d.c.count; e++) {
            ...
            for (var g = 0; g < f._segments.count; g++) {
                ...
                if (GeometryUtil.b(b, f._startPoint, h._points, a.gc(c))) {
                    return true;
                }
            }
        }
    ...
    SeriesInteractionManager.prototype.a$k = function (a, b, c) {
        ...
        var f = a.getEffectiveViewport1(a.b1);
        var g = null;
        if (c.cm) {
            g = c;
        }
        ...
        h.c = a.getEffectiveViewport1(a.b1);
        var i = a.pz(a.b1);
        var j = 0;
        if (c.co) {
            var k = c.el(i.top, h);
    ...
    SeriesInteractionManager.prototype.a$g = function (a, b, c) {
        ...
        var e = RectUtil.r(d, a.gc(c));
        return e.containsPoint(b);
    };
    SeriesInteractionManager.prototype.a$al = function (a, b, c, d, e, f, g, h, i, j) {
        if (f == null || g == null || a.b1 == null || a.b1.bv.isEmpty || a.b1.bu.isEmpty) {
            return { $type: Point_$type, x: NaN, y: NaN };
        }
        var k = a.getEffectiveViewport1(a.b1);
        var l = new ScalerParams(0, a.b1.bv, a.b1.bu, f.cg, k);
        if (f.co) {
            l.b = a.gg();
        }
        l.c = a.getEffectiveViewport1(a.b1);
        var m = a.b1;
        var n = a.pz(m);
        var o;
        if (g.co) {
        ...
        if (!c && g != null) {
            ...
            r.c = a.ce.te;
            var s = a.f7(b, p, g, r, e);
            var t = a.f7(b, q, g, r, e);
            var u = q;
            var v = p;
            if (g.cm) {
                var w = g;
    ...
    SeriesInteractionManager.prototype.a$v = function (a, b, c, d, e, f, g, h, i) {
        ...
        var s = (f && (!k || g)) || i || (!a.c6 && k && l && !h);
        var t = !s && (e || (k && a.c6) || (!a.c6 && k && !l) || (!a.c6 && k && l && h));
        if (q && this.a != null) {
            m = this.a;
        }
        else {
    ...
    SeriesInteractionManager.prototype.a$y = function (a, b, c, d, e) {
        ...
        if (a.ce != null && !this.c) {
            ...
            this.a$v(a, g, a.px(b), e, true, false, false, a == a.ce.bo, false);
            a.ce.nk(a, g, d);
        }
    };
    SeriesInteractionManager.prototype.a$ai = function (a, b) {
        ...
        var d = null;
        var e;
        var f = ((function () { var g = a.ce.cu.f(b, false, e, false); e = g.p2; return g.ret; })());
        if (f != a) {
            if (this.a$c) {
    ...
    SeriesInteractionManager.prototype.a$ab = function (a, b, c, d, e) {
        ...
        if (a.ce != null && f != null && this.c) {
            this.c = false;
            this.d = true;
            this.a$v(a, f, a.px(b), e, true, false, false, a == a.ce.bo, false);
            a.ce.nk(a, f, d);
        }
        if (a.ce != null && (!a.es || f != null) && !this.c) {
            this.a$v(a, f, a.px(b), e, true, false, false, a == a.ce.bo, false);
            a.ce.no(a, f, d);
        }
        if (f == null && !this.c && a.es) {
            this.a$v(a, f, a.px(b), e, false, true, false, a == a.ce.bo, false);
            a.ce.nl(a, this.a$p, d);
            this.d = false;
            this.c = true;
        }
    };
    ...
    SeriesInteractionManager.prototype.r = function (a, b, c, d) {
        ...
        if (this._toolTipObject != null) {
            if (this.f || g) {
                ...
                this._toolTipObject.addClass(a.ce.kr);
                a.ce.lk(this._toolTipObject);
    ...
    SeriesInteractionManager.prototype.a$ah = function (a, b, c) {
        this.j = true;
        var d = { $type: Point_$type, x: b.x + a.b1.bu.left, y: b.y + a.b1.bu.top };
        var e = a.h4(null, d);
        if (a.b1.d != null) {
            a.b1.d.series = a;
            a.b1.d.item = e;
    ...
    SeriesInteractionManager.prototype.a$r = function (a) {
        var b = new Color();
        var c = a != null && a.ce != null && a.ce.cu != null && a.ce.cu.j != null ? a.ce.cu.j.ae : null;
        c.startCSSQuery();
    ...
    SeriesInteractionManager.prototype.a$aj = function (a, b) {
        ...
        if (typeof b === 'string') {
            ...
            if (this._toolTipObject != null) {
                ...
                var d = a.o8 != null && Color.e(toNullable(Color.$, a.o8.color), toNullable(Color.$, null)) && a.o8.color.l > 0;
                if (d) {
                    this._toolTipObject.setStyleProperty("border-color", a.o8._fill);
                }
            }
            else {
                if (!this.e && c != null) {
