...
var RadialAreaSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialAreaSeries.prototype.get_df = function () {
        return true;
    };
    RadialAreaSeries.prototype.by = function () {
        return new RadialAreaSeriesView(this);
    };
    RadialAreaSeries.prototype.l4 = function (a) {
    ...
    RadialAreaSeries.prototype.k2 = function (a, b) {
        _super.prototype.k2.call(this, a, b);
        this.uf.c1();
    };
    RadialAreaSeries.prototype.sy = function (a, b) {
    ...
    RadialAreaSeries.prototype.l9 = function (a, b, c, d) {
    ...
    RadialAreaSeries.prototype.get_tf = function () {
        return true;
    };
    RadialAreaSeries.$t = markType(RadialAreaSeries, 'RadialAreaSeries', AnchoredRadialSeries.$);
    RadialAreaSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialAreaSeries, 'raisePropertyChanged', ['UnknownValuePlotting:ug:ui', [UnknownValuePlotting_$type, enumGetBox(UnknownValuePlotting_$type, 1)]]);
