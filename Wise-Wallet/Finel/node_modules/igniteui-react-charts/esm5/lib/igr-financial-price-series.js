...
var IgrFinancialPriceSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(IgrFinancialPriceSeries.prototype, "trendLineDashArray", {
        /**
    ...
    */
    IgrFinancialPriceSeries.prototype.getSeriesValueType = function (mode) {
        var iv = this.i.am((mode == null ? null : mode));
        return (iv);
    };
    IgrFinancialPriceSeries.prototype.getSeriesValueTypePosition = function (mode) {
        var iv = this.i.pv((mode == null ? null : mode));
        return fromPoint(iv);
    };
    IgrFinancialPriceSeries.prototype.getSeriesValueTypePositionFromValue = function (values) {
