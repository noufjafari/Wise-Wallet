...
var Arc = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Arc.prototype.gn = function (a) {
        _super.prototype.gn.call(this, a);
        this.jf = a;
    };
    Object.defineProperty(Arc.prototype, "jh", {
        ...
        set: function (a) {
            var b = this.jg;
            this.jg = a;
            this.jf.b8(b, this.jg);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Arc.prototype, "jk", {
        get: function () {
            if (this.jh != null) {
                return this.jh.i;
            }
    ...
    Arc.prototype.gj = function (a, b) {
        _super.prototype.gj.call(this, a, b);
        if (this.jh != null) {
            this.jh.c.ax.bu(a, b);
        }
    };
    Arc.prototype.fy = function (a, b) {
        if (this.jh != null && this.jh.d != null) {
            _super.prototype.fy.call(this, a, b);
            var c = this.ji(a);
            if (c != null) {
                this.jh.d.bj(c, b);
            }
    ...
    Arc.prototype.g1 = function (a, b) {
        if (this.jh != null && this.jh.d != null) {
            _super.prototype.g1.call(this, a, b);
            var c = this.ji(a);
            if (c != null) {
                this.jh.d.b5(c, b);
            }
    ...
    Arc.prototype.ji = function (a) {
        var e_1, _a;
        try {
            for (var _b = __values(fromEnum(this.je.g)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                if (b.b == a) {
                    return b;
                }
    ...
    Arc.prototype.gq = function () {
        if (this.actualItemsSource == null || this.bl == null) {
            this.bw.count = 0;
            return;
        }
        var a = this.cn.count;
        var b = this.cm.count > 0;
        var c = PieChartBase.dg(this.c3);
        var d = PieChartBase.dg(this.c3);
        this.dl = a;
        if (b) {
            a++;
        }
        for (var e = 0; e < a; e++) {
            ...
            if (this.i2 == 1) {
                d += PieChartBase.dg(Math.abs(g) * this.jl / this.di);
            }
            else {
                d -= PieChartBase.dg(Math.abs(g) * this.jl / this.di);
            }
            var h = this.bw.item(e);
            if (this.c0 >= 100) {
                h._visibility = 1;
            }
            else {
    ...
    Arc.prototype.gx = function () {
        ...
        if (this.bq == null || this.bq.count == 0 || ((this.jh != null && this.jh.c != null) && (this.jh.d != null && !this.jh.d.series.contains(this.jh.c)))) {
            a.clearLegendItemsForSeries(this.jh.c);
            return;
        }
        ...
        var _loop_1 = function (b) {
            ...
            var d = this_1.dn(b);
            var e = b.b0;
            var f = b.isOthersSlice ? this_1.e5 : (this_1.br != null && this_1.br.count > 0) ? this_1.br.item(this_1.cn._inner[b.a5]) : null;
            f = (f == null && this_1.bq.count > 0) ? this_1.bq.item(this_1.cn._inner[b.a5]) : f;
            c.content = ((function () {
                var $ret = new PieSliceDataContext();
                $ret.series = _this.jh.c;
                $ret.slice = b;
                $ret.item = b.dataContext;
                $ret.itemBrush = e;
                $ret.legendLabel = f != null ? f.toString() : null;
                $ret.itemLabel = d != null ? d.toString() : null;
                $ret.percentValue = _this.c8(b);
        ...
        var this_1 = this;
        try {
            for (var _b = __values(fromEnum(this.bw.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                _loop_1(b);
            }
        }
        ...
        if (a.isItemwise) {
            var k = a;
            k.createLegendItemsInsert(this.ck, this.jh.c);
        }
    };
    Arc.prototype.gr = function (a, b, c, d) {
        _super.prototype.gr.call(this, a, b, c, d);
        switch (b) {
            case Arc.$$p[0]:
                this.jj = d;
                this.gq();
            ...
            case "Legend":
                ...
                if (e != null && this.jh != null && this.jh.c != null) {
                    e.clearLegendItemsForSeries(this.jh.c);
                }
                break;
        }
    };
    Arc.prototype.jm = function () {
        return this.a4.ad();
    };
    Arc.$t = markType(Arc, 'Arc', PieChartBase.$);
    Arc.$$p = markDep(DependencyProperty, PropertyMetadata, Arc, 'gt', ['EndAngle:jl:jo', [1, 360]]);
    return Arc;
}(PieChartBase));
export { Arc };
/**
...
var ArcItem = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ArcItem.prototype.o = function (a, b) {
        ...
        var o = e.count;
        var p = f.count > 0;
        var q = PieChartBase.dg(a);
        var r = PieChartBase.dg(a);
        if (p) {
            o++;
        }
        var _loop_2 = function (s) {
            ...
            var v = 1;
            if (v == 1) {
                r += PieChartBase.dg(Math.abs(u) * b / c);
            }
            else {
                r -= PieChartBase.dg(Math.abs(u) * b / c);
            }
...
var RingControl = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RingControl.prototype.au = function (source_, a, b, c) {
        for (var d = 0; d < this.arcs.count; d++) {
            this.arcs.item(d).f8(source_, a, b, c);
        }
    };
            ...
            switch (_d.label) {
                ...
                case 1:
                    if (!!_b.done)
                        return [3 /*break*/, 4];
                    b = _b.value;
                    if (!PieChartBase.cj(a, b.itemsSource))
                        return [3 /*break*/, 3];
                    return [4 /*yield*/, b];
                case 2:
                    _d.sent();
...
var RingControlView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RingControlView.prototype.a = function () {
        ...
        a.ce = true;
        a.df = this.b.al.a9;
        a.b7 = this.b.al.ax.av;
        a.b8 = this.b.al.ax.aw;
        a.a6 = this.b.al.ar;
        a.ey = this.b.al.b3;
        a.c1 = this.b.al.ax.a1;
        return a;
    };
        ...
        switch (b.propertyName) {
            case "LabelExtent":
                for (var c = 0; c < this.f.count; c++) {
                    this.f._inner[c].da = b.newValue;
                }
                break;
            case "LabelMemberPath":
                for (var d = 0; d < this.f.count; d++) {
                    this.f._inner[d].ei = b.newValue;
                }
                break;
            case "LabelsPosition":
            ...
            case "LabelTemplate":
                for (var f = 0; f < this.f.count; f++) {
                    this.f._inner[f].hb = b.newValue;
                }
                break;
            case "ValueMemberPath":
                for (var g = 0; g < this.f.count; g++) {
                    this.f._inner[g].fu = b.newValue;
                }
                break;
            case "ToolTip":
                for (var h = 0; h < this.f.count; h++) {
                    this.f._inner[h].dq = b.newValue;
                }
                break;
            case "LeaderLineVisibility":
                for (var i = 0; i < this.f.count; i++) {
                    this.f._inner[i].jd = EnumUtil.getEnumValue(Visibility_$type, b.newValue);
                }
                break;
            case "LeaderLineStyle":
                for (var j = 0; j < this.f.count; j++) {
                    this.f._inner[j].i9 = b.newValue;
                }
                break;
            case "LeaderLineType":
            ...
            case "LeaderLineMargin":
                for (var l = 0; l < this.f.count; l++) {
                    this.f._inner[l].db = b.newValue;
                }
                break;
            case "OthersCategoryThreshold":
                for (var m = 0; m < this.f.count; m++) {
                    this.f._inner[m].dc = b.newValue;
                }
                break;
            ...
            case "OthersCategoryText":
                for (var o = 0; o < this.f.count; o++) {
                    this.f._inner[o].e5 = b.newValue;
                }
                break;
            case "OthersCategoryStyle":
                for (var p = 0; p < this.f.count; p++) {
                    this.f._inner[p].ja = b.newValue;
                }
                break;
            case "Legend":
            ...
            case "SelectedStyle":
                for (var v = 0; v < this.f.count; v++) {
                    this.f._inner[v].jb = b.newValue;
                }
                break;
            case "SelectedStyleResolved":
                for (var w = 0; w < this.f.count; w++) {
                    this.f._inner[w].jb = b.newValue;
                }
                break;
            case "RadiusFactor":
                for (var x = 0; x < this.f.count; x++) {
                    this.f._inner[x].df = b.newValue;
                }
                break;
        }
    };
