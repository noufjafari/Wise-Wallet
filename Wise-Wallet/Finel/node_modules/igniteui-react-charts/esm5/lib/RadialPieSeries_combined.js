...
var RadialPieSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialPieSeries.prototype.get_d7 = function () {
        return true;
    };
    RadialPieSeries.prototype.get_d5 = function () {
        return true;
    };
    RadialPieSeries.prototype.gz = function () {
        if (!isNaN_(this.gy)) {
            return _super.prototype.gz.call(this);
        }
        return Defaults.h;
    };
    RadialPieSeries.prototype.by = function () {
        return new RadialPieSeriesView(this);
    };
    RadialPieSeries.prototype.l4 = function (a) {
    ...
    RadialPieSeries.prototype.k2 = function (a, b) {
    ...
    RadialPieSeries.prototype.ge = function () {
        return this.rt.k3(this.b1.bv, this.b1.bu, this.getEffectiveViewport1(this.b1));
    };
    RadialPieSeries.prototype.get_c3 = function () {
        return true;
    };
    RadialPieSeries.prototype.sy = function (a, b) {
        ...
        for (var x = 0; x < i.count; ++x) {
            ...
            var ad = null;
            if (q) {
                ad = this.um(d, e, z - (m * 0.5), z + (m * 0.5), l, aa, n, ab, ac);
            }
            else {
                ad = this.un(d, e, z - (m * 0.5), z + (m * 0.5), l, aa, n);
            }
            y.an = ad;
            this.r7.ad(y, false, false, false, false);
            var ae = i._inner[x][2];
            if (ae > w) {
                w = ae;
            }
    ...
    RadialPieSeries.prototype.un = function (a, b, c, d, e, f, g) {
    ...
    RadialPieSeries.prototype.um = function (a, b, c, d, e, f, g, h, i) {
        var j = SliceCoords.a(a, b, c, d, e, f, g, h, i);
        if (j == null) {
            return this.un(a, b, c, d, e, f, g);
        }
    ...
    RadialPieSeries.prototype.l9 = function (a, b, c, d) {
    ...
    RadialPieSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RadialPieSeries, 'raisePropertyChanged', ['RadiusX:ug:uk', [1, 2], 'RadiusY:uh:ul', [1, 2]]);
    ...
    RadialPieSeriesView.prototype.al = function (a) {
        ...
        try {
            for (var _b = __values(fromEnum(this.c1.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
                this.e.a9.exportPathData(a, c, "slice" + b, ["Main", "Fill"]);
                b++;
            }
        }
        catch (e_1_1) {
