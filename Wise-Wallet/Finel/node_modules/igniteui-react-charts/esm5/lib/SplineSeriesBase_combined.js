...
var SplineSeriesBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineSeriesBase.prototype.gz = function () {
        if (!isNaN_(this.gy)) {
            return _super.prototype.gz.call(this);
        }
        return this.vm.db();
    };
    SplineSeriesBase.prototype.by = function () {
        return new SplineSeriesBaseView(this);
    };
    SplineSeriesBase.prototype.l4 = function (a) {
        _super.prototype.l4.call(this, a);
        this.vm = a;
    };
    SplineSeriesBase.prototype.mt = function (a) {
        _super.prototype.mt.call(this, a);
        this.vo = true;
    };
    SplineSeriesBase.prototype.aq = function (a) {
        if (!this.vo || this.vl == null || this.vl.length == 0) {
            return _super.prototype.aq.call(this, a);
        }
        ...
        if (a == this.fetchYAxis()) {
            if (isNaN_(this.vu) || isNaN_(this.vv)) {
                return null;
            }
            return new AxisRange(this.vv, this.vu);
        }
        return null;
    };
    SplineSeriesBase.prototype.get_dg = function () {
        return true;
    };
    SplineSeriesBase.prototype.vj = function (a) {
        var _this = this;
        if (a.cr.d == 0) {
            return null;
        }
    ...
    SplineSeriesBase.prototype.vk = function (a) {
        var _this = this;
        var b = typeCast(ISortingAxis_$type, this.u0);
    ...
    SplineSeriesBase.prototype.vz = function (a, b, c, d, e, f) {
        var _this = this;
        ...
        for (var w = q; w < p + 1; ++w) {
            ...
            if (w >= (this.valueColumn.count - 1)) {
                if (k && this.vp(a, a.f._inner[a.f.count - 1], s, Math.min(y, this.cl.count - 1), l, f, u - 1)) {
                    ++l;
                }
                break;
            }
            ...
            if (k && this.vp(a, x, s, Math.min(y, this.cl.count - 1), l, f, v - 1)) {
                ++l;
            }
        }
        f.cu.count = l;
    };
    SplineSeriesBase.prototype.vp = function (a, b, c, d, e, f, g) {
        var h = b[0];
        var i = b[1];
    ...
    SplineSeriesBase.prototype.aj = function (a, b, c, d, e, f) {
        ...
        var m = this.ho(e, f);
        var n = this.hm(e, f);
        var o = truncate(Math.floor(m / this.sx(this.b1)));
        var p = truncate(Math.floor(n / this.sx(this.b1)));
        j = o - this.sy(this.b1);
        k = p - this.sy(this.b1);
        var q = j * i;
        var r = k * i;
        ...
        if (j > this.rx.f.count - 1) {
            j = this.rx.f.count - 1;
        }
        if (k < 0) {
            k = 0;
        }
        if (k > this.rx.f.count - 1) {
            k = this.rx.f.count - 1;
        }
        var u = this.rx.f._inner[j];
        var v = this.rx.f._inner[k];
        var w = new Array(2);
        w[0] = u;
        w[1] = v;
        return w;
    };
    SplineSeriesBase.prototype.tc = function (a, b) {
        var _this = this;
        _super.prototype.tc.call(this, a, b);
        if (a.f.count <= 1) {
            return;
        }
        if (b.cr.d == 0) {
        ...
        var j = this.qn();
        var k = 0;
        var l = typeCast(ISortingAxis_$type, this.u0);
        if (l != null && l.i$b.count != this.cl.count) {
            return;
        }
        var m = this.vt(f, c, d, e);
        var n = b.cr.d;
        this.vy(b);
        var o = b.cr.f;
        var p = b.cr.e;
        ...
        for (var x = p; x <= o; ++x) {
            ...
            if (n == 1) {
                if (x >= (this.valueColumn.count - 1)) {
                    if (j && this.vp(a, a.f._inner[a.f.count - 1], r, Math.min(x * n, this.cl.count - 1), k, b, v - 1)) {
                        ++k;
                    }
                    break;
                }
            ...
            if (j && this.vp(a, y, r, Math.min(x * n, this.cl.count - 1), k, b, w - 1)) {
                ++k;
            }
        }
        u.c8();
    ...
    SplineSeriesBase.prototype.vy = function (a) {
        var _this = this;
        var b = a.cr.d;
        ...
        if ((this.vl == null || this.vl.length != this.valueColumn.count) && b == 1) {
            var e = this.vn == 0 ? NaN : 0;
            if (this.u0 != null && typeCast(ISortingAxis_$type, this.u0) !== null && this.u0.i$b != null) {
                var f_1 = new SafeSortedReadOnlyDoubleCollection(1, this.valueColumn, this.u0.i$b, NaN);
                d = function (g) { return f_1.item(g); };
            }
            this.vl = Numeric.c(this.valueColumn.count, c, d, e, e);
            if (this.vo) {
    ...
    SplineSeriesBase.prototype.vs = function (a, b, c, d, e, f, g) {
        var h = d - b;
        var i = b + h * a;
        var j = (d - i) / h;
        var k = (i - b) / h;
    ...
    SplineSeriesBase.prototype.gd = function (a, b, c, d, e, f, g, h) {
        var i = NaN;
        if (c >= 0 && c < b.count) {
            i = b.item(c);
        }
        ...
        var o = NaN;
        var p = NaN;
        if (this.vl != null && e >= 0 && e < this.vl.length) {
            o = this.vl[e];
        }
        if (this.vl != null && f >= 0 && f < this.vl.length) {
            p = this.vl[f];
        }
        return this.vs(a, k, m, l, n, o, p);
    };
    SplineSeriesBase.prototype.vt = function (a, b, c, d) {
    ...
    Object.defineProperty(SplineSeriesBase.prototype, "vv", {
        get: function () {
            return this.vr;
        },
        set: function (a) {
    ...
    Object.defineProperty(SplineSeriesBase.prototype, "vu", {
        get: function () {
            return this.vq;
        },
        set: function (a) {
    ...
    SplineSeriesBase.prototype.v0 = function () {
        this.vl = null;
        this.vv = NaN;
        this.vu = NaN;
        if (this.yAxis != null) {
    ...
    SplineSeriesBase.prototype.k5 = function (a, b, c, d) {
        this.v0();
    ...
    SplineSeriesBase.$$p = markDep(DependencyProperty, PropertyMetadata, SplineSeriesBase, 'raisePropertyChanged', ['IsSplineShapePartOfRange:vo:v1', [0, false], 'SplineType:vn:v2', [SplineType_$type, enumGetBox(SplineType_$type, 0)]]);
