...
var ShapeSeriesBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function ShapeSeriesBase() {
        ...
        _this.q0 = new ShapeSeriesRenderManager();
        FastItemObjectColumn.m();
        _this.rs = _this.rr;
        _this.sw = Rect.empty;
        return _this;
    }
    ShapeSeriesBase.prototype.kz = function () {
    ...
    ShapeSeriesBase.prototype.h1 = function (a, b) {
        var c = this.jv(b);
    ...
    ShapeSeriesBase.prototype.get_d0 = function () {
        return true;
    };
    ShapeSeriesBase.prototype.get_c3 = function () {
        return true;
    };
    ShapeSeriesBase.prototype.qo = function (a, b, c) {
        var d = this.pn(b);
        var e = this.q1.cz(d, false);
        var f = -1;
        if (e == null) {
            if (a != null) {
                f = this.cl.indexOf(a);
    ...
    ShapeSeriesBase.prototype.qp = function (a, b, c) {
        var d = this.q1.b1(this.pn(b));
        var e = -1;
        if (d == null) {
            if (a != null) {
                e = this.cl.indexOf(a);
    ...
    ShapeSeriesBase.prototype.qy = function () {
        if (this.qz != 0) {
            return this.qz;
        }
        return 1;
    };
    ShapeSeriesBase.prototype.f9 = function (a) {
        switch (this.qx) {
    ...
    ShapeSeriesBase.prototype.sb = function (a) {
        var b = this.pn(a);
        ...
        var e = this.q1.b2(b, false, !this.q6);
        if (e != null) {
            c = RectUtil.l(e.d);
    ...
    ShapeSeriesBase.prototype.sa = function (a) {
        ...
        var h = this.q1.b2(b, false, !this.q6);
        if (h != null) {
            var i = RectUtil.l(h.d);
            var j = this.r9(b, h.a, this.q6);
        ...
        for (var q = 0; q < g.count; q++) {
            ...
            if (s < f) {
                var t = this.r9(b, g._inner[q].a, this.q6);
                if (t.c < o) {
                    o = t.c;
                    e = t.d;
                    p = q;
    ...
    ShapeSeriesBase.prototype.r9 = function (a, b, c) {
    ...
    ShapeSeriesBase.prototype.rq = function (a) {
        return this.sa(a).c;
    };
    ShapeSeriesBase.prototype.ps = function (a, b, c) {
    ...
    ShapeSeriesBase.prototype.hy = function (a) {
        var b = this.hi(a);
    ...
    ShapeSeriesBase.prototype.qn = function (a, b, c) {
    ...
    ShapeSeriesBase.prototype.ax = function (a, b, c) {
        if (this.c3 && this.ei(this.bl) && !c) {
            var d = this.qo(a, b, this.qq);
            this.qq = d;
            return d;
        }
        else {
            var e = this.qn(a, b, this.qq);
            this.qq = e;
            return e;
        }
    };
    ShapeSeriesBase.prototype.ay = function (a, b, c) {
        if (this.ei(this.bl) && !c) {
            var d = this.qp(a, b, this.qr);
            this.qr = d;
            return d;
        }
        else {
            var e = this.qn(a, b, this.qr);
            e.e = true;
            this.qr = e;
            return e;
        }
    };
    ShapeSeriesBase.prototype.rj = function () {
        return (this.assigningShapeStyle != null && this.q5) || (this.bl != 1);
    };
    ShapeSeriesBase.prototype.ri = function () {
        return (this.assigningShapeMarkerStyle != null && this.q4) || (this.bl != 1);
    };
    Object.defineProperty(ShapeSeriesBase.prototype, "q3", {
        get: function () {
            return this.q2;
        },
        set: function (a) {
    ...
    ShapeSeriesBase.prototype.ra = function (array_) {
        var a = (Array.isArray(array_));
        return a;
    };
    ShapeSeriesBase.re = function (a) {
        if (a == null) {
            return true;
        }
        var val_ = a;
    ...
    ShapeSeriesBase.prototype.ck = function (a) {
        ...
        return _super.prototype.ck.call(this, a);
    };
    ShapeSeriesBase.prototype.l9 = function (a, b, c, d) {
    ...
    ShapeSeriesBase.prototype.rh = function () {
        return this.rd;
    };
    ShapeSeriesBase.prototype.rg = function () {
        return this.rc;
    };
    ShapeSeriesBase.prototype.q8 = function (a) {
        if (typeCast(NumericYAxis.$, a) !== null) {
            return true;
        }
        return false;
    };
    ShapeSeriesBase.prototype.q7 = function (a) {
        if (typeCast(NumericXAxis.$, a) !== null) {
            return true;
        }
        return false;
    };
    ShapeSeriesBase.prototype.sk = function () {
        this.rl = null;
        if (this.q3 == null) {
            return;
        }
        this.rl = new List$1(Rect.$, 2, this.q3.count);
        for (var a = 0; a < this.q3.count; a++) {
            this.rl.add(PointCollectionUtil.j(this.q3.item(a)));
        }
    };
    ShapeSeriesBase.prototype.sx = function (a) {
    ...
    ShapeSeriesBase.prototype.rn = function (a, b, c, d, e, f, g) {
        var e_1, _a;
        ...
        if (typeCast(List$1.$.specialize(List$1.$.specialize(Point_$type)), c) !== null) {
            ...
            var l = c;
            var m = this.qm(a, b, PointCollectionUtil.b(l), d, e, f, g);
    ...
    ShapeSeriesBase.prototype.get_rb = function () {
        return true;
    };
    Object.defineProperty(ShapeSeriesBase.prototype, "rb", {
        get: function () {
            return this.get_rb();
        },
        enumerable: false,
    ...
    ShapeSeriesBase.prototype.rk = function () {
        return false;
    };
    ...
    ShapeSeriesBase.prototype.sj = function (a) {
        var _this = this;
        if (this.cy(a)) {
            return;
        }
        ...
        if (!this.ew) {
            ...
            for (var aj = 0; aj < p; aj++) {
                ...
                if (k.intersectsWith(c)) {
                    ...
                    var ak = this.rn(a, ai, w.item(aj), i, j, 0, ag);
                    if (ad) {
                    ...
                    if (k.intersectsWith(c)) {
                        ...
                        var al = this.rn(a, ai, w.item(aj), i, j, ag, ag);
                        if (ad) {
        ...
        d.cm(function (as) {
            ...
            d.cj(as, at, am);
            if (an) {
                _this.sf(as, aq, au, _this.q3.count, ap, ar);
            }
            else {
                if (ar) {
                    {
                        _this.q0.a1(as, _this.fv, ar);
                    }
                }
            }
            {
                _this.q0.ad(as, false, false, false, false);
            }
        });
    };
    ShapeSeriesBase.prototype.sf = function (a, b, c, d, e, f) {
        var g = this.bl != 1;
    ...
    ShapeSeriesBase.prototype.se = function (a, b, c) {
        var d = this.bl != 1;
    ...
    ShapeSeriesBase.prototype.sh = function (a) {
        if (this.assigningShapeStyle != null && this.q5) {
            this.assigningShapeStyle(this, a);
        }
    };
    ShapeSeriesBase.prototype.sg = function (a) {
        if (this.assigningShapeMarkerStyle != null && this.q4) {
            this.assigningShapeMarkerStyle(this, a);
        }
    };
    ShapeSeriesBase.prototype.qi = function (a, b) {
        return this.qj(a, b);
    };
    ShapeSeriesBase.prototype.qj = function (a, b) {
    ...
    ShapeSeriesBase.si = function (a, b, c) {
        var d = 0;
        var e = null;
    ...
    ShapeSeriesBase.prototype.na = function (a, b) {
        this.mn(false);
    };
    ShapeSeriesBase.prototype.k5 = function (a, b, c, d) {
    ...
    ShapeSeriesBase.prototype.get_rf = function () {
        return true;
    };
    Object.defineProperty(ShapeSeriesBase.prototype, "rf", {
        get: function () {
            return this.get_rf();
        },
        enumerable: false,
    ...
    ShapeSeriesBase.prototype.l4 = function (a) {
        _super.prototype.l4.call(this, a);
        this.q1 = typeCast(ShapeSeriesViewBase.$, a);
    };
    ShapeSeriesBase.prototype.ro = function (a, b, c, d, e, f, g) {
        var h = new List$1(FlattenedShape.$, 0);
        var i;
        var j = c.count;
        for (var k = 0; k < j; k++) {
            i = c._inner[k];
            var l = this.qm(a, b, i, d, e, f, g);
            if (l == null) {
                continue;
            }
            h.add(l);
    ...
    ShapeSeriesBase.prototype.qm = function (a, b, c, d, e, f, g) {
        var h = this.sc(c, d, e);
        var i = h.c;
        var j = h.d;
        var k = i.length;
        ...
        var t = !(l > this.sw.right || n < this.sw.left || m > this.sw.bottom || o < this.sw.top);
        if (!t && f == 0 && g != 0) {
            if (g != 0) {
                for (var u = 0; u < k; u++) {
                    i[u] = i[u] + g;
        ...
        var w = b != null && (l < this.sw.left || m < this.sw.top || n > this.sw.right || o > this.sw.bottom);
        ...
        var y = PolySimplification.b(h, this.fx);
        var z = new DefaultFlattener().c(h.c, h.d, y, this.rp);
        var aa = z.count;
        if (w) {
    ...
    ShapeSeriesBase.prototype.sc = function (a, b, c) {
        var d = this.qs;
        var e = this.qu;
        var f = a.count;
        var g = new Array(f);
    ...
    ShapeSeriesBase.prototype.k2 = function (a, b) {
    ...
    ShapeSeriesBase.prototype.rw = function (a) {
        return this.cl.item(a);
    };
    ShapeSeriesBase.prototype.get_e7 = function () {
        return true;
    };
    ShapeSeriesBase.prototype.set_e7 = function (a) {
        _super.prototype.set_e7.call(this, a);
    };
    ShapeSeriesBase.prototype.aq = function (a) {
        var e_2, _a, e_3, _b;
        if (typeCast(NumericXAxis.$, a) !== null && this.rl != null) {
            var b = 1.7976931348623157E+308;
            var c = -1.7976931348623157E+308;
            try {
                for (var _c = __values(fromEnum(this.rl)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var d = _d.value;
                    b = Math.min(b, d.left);
        ...
        if (typeCast(NumericYAxis.$, a) !== null && this.rl != null) {
            ...
            var f = -1.7976931348623157E+308;
            try {
                for (var _e = __values(fromEnum(this.rl)), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var g = _f.value;
                    e = Math.min(e, g.top);
    ...
    ShapeSeriesBase.prototype.get_eg = function () {
        return true;
    };
    ShapeSeriesBase.prototype.get_d5 = function () {
        return true;
    };
    Object.defineProperty(ShapeSeriesBase.prototype, "q9", {
        get: function () {
    ...
    ShapeSeriesBase.prototype.sy = function (a, b, c) {
    ...
    ShapeSeriesViewBase.prototype.b2 = function (a, b, c) {
        ...
        for (var i = 0; i < f; i++) {
            ...
            if (d >= h.d.left && d <= h.d.right && e >= h.d.top && e <= h.d.bottom) {
                if (c) {
                    var j = this.b3.fy / 2 + this.b3.gc(b);
