...
var SeriesViewerSurfaceViewer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(SeriesViewerSurfaceViewer.prototype, "maximumZoomLevel", {
        get: function () {
            if (this.l.gh == 0.0001 && this.l.gg == 0.0001) {
                return 0.9;
            }
            else {
                return 1 - Math.max(this.l.gh, this.l.gg);
            }
        },
        enumerable: false,
        configurable: true
        ...
        switch (a) {
            case SeriesViewerSurfaceViewer.$$p[0]:
                ...
                if (!this.o && !d) {
                    ...
                    var f = RectUtil.l(this.l.ta);
                    var g = new Rect(0, f.x - e / 2, f.y - e / 2, e, e);
                    this.l.tq = SeriesViewerSurfaceViewer.z(this.l.tq, g, this.l.er(), this.l.es(), this.worldRect);
                }
                this.w();
                if (this.l.cn != null) {
