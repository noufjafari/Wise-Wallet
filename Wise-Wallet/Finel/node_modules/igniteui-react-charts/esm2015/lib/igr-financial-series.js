...
export class IgrFinancialSeries extends IgrSeries {
    ...
    */
    ...
    set transitionInMode(v) {
        this.i.qv = ensureEnum(CategoryTransitionInMode_$type, v);
    }
    /**
    ...
    */
    ...
    getSeriesCloseValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.sc(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesOpenValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.sd(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesVolumeValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.se(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    ...
    getSeriesOpenValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.ts(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesCloseValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.tr(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesVolumeValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.tt(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    /**
