...
export class IgrPolarBase extends IgrMarkerSeries {
    ...
    */
    get angleAxis() {
        ...
        if (!r.externalObject) {
            let e = IgrNumericAngleAxis._createFromInternal(r);
            if (e) {
                e._implementation = r;
            }
            r.externalObject = e;
    ...
    */
    ...
    set radiusAxis(v) {
        if (v != null && this._stylingContainer && v._styling)
            v._styling(this._stylingContainer, this, this);
        v == null ? this.i.r3 = null : this.i.r3 = v.i;
    }
    /**
    ...
    */
    ...
    set trendLineType(v) {
        this.i.sk = ensureEnum(TrendLineType_$type, v);
    }
    /**
    ...
    */
    get trendLineDashArray() {
        return fromDoubleCollection(this.i.u4);
    }
    set trendLineDashArray(v) {
        this.i.u4 = toDoubleCollection(v);
    }
    /**
    ...
    */
    ...
    set actualItemSearchMode(v) {
        this.i.sg = ensureEnum(ScatterItemSearchMode_$type, v);
    }
    /**
    ...
    */
    ...
    set itemSearchMode(v) {
        this.i.si = ensureEnum(ScatterItemSearchMode_$type, v);
    }
    /**
