...
export let ItemToolTipLayer = /*@__PURE__*/ (() => {
    class ItemToolTipLayer extends AnnotationLayer {
        ...
        qw(a) {
            ...
            if (this.ti != null) {
                if (a.dx) {
                    let b = a.ju();
                    if (!Base.equalsStatic(this.ti, b)) {
                        return false;
                    }
                }
                else {
                    if (!Base.equalsStatic(this.ti, a.name)) {
                        return false;
                    }
                }
            }
        ...
        tn(a, b, c, d, e) {
            ...
            if (!this.tb.b6(a, l, i, n)) {
                return;
            }
            let o = this.tb.ch(l, i, n);
            b.i.add1(l);
            b.j.add1(n);
            b.l.add1(i);
            let p = g.x;
    ...
    ItemToolTipLayer.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ItemToolTipLayer, 'raisePropertyChanged', ['SkipUnknownValues:te:to', [0, true], 'TargetSeriesName:ti:tp', [2, null], 'TargetSeries:tc:tq', [Series.$, null], 'UseInterpolation:tf:tr', [0, false]]);
...
export let ItemToolTipLayerView = /*@__PURE__*/ (() => {
    class ItemToolTipLayerView extends AnnotationLayerView {
        ...
        b6(a, b, c, d) {
            let e = b;
            if (a.h7 == "default") {
                a.h7 = a.b1.getDefaultTooltipTemplate();
            }
            let template_ = a.h7;
            let context_ = d;
            if (a.toolTip == null) {
        ...
        al(a) {
            ...
            for (let tooltip_ of fromEnum(this.b5.a)) {
                ...
                this.e.a9.addPointerTooltipData(a, c, d, e, f);
            }
        }
        ce(a) {
            this.aq();
