...
export let StochRSIIndicator = /*@__PURE__*/ (() => {
    class StochRSIIndicator extends StrategyBasedIndicator {
        ...
        get va() {
            return typeGetValue(this.c(StochRSIIndicator.vb));
        }
        set va(a) {
            this.h(StochRSIIndicator.vb, a);
        }
        uv() {
            return this.va;
        }
    ...
    StochRSIIndicator.vb = /*@__PURE__*/ StrategyBasedIndicator.u7(14, StochRSIIndicator.$);
    return StochRSIIndicator;
})();
