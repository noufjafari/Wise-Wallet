...
export let ScatterContourSeries = /*@__PURE__*/ (() => {
    class ScatterContourSeries extends ScatterTriangulationSeries {
        ...
        constructor() {
            ...
            this.r6 = new LinearContourValueResolver();
        }
        h1(a, b) {
            let c = this.jv(b);
        ...
        getDataLegendSeriesContextAt(a, b) {
            ...
            let g = d == null ? NaN : this.gf(d, "ValueMemberPath");
        ...
        sm(a) {
            ...
            c = e.p0;
            b = e.p1;
            let f = new ScalerParams(1, b, c, this.qc.cg);
            f.c = this.getEffectiveViewport1(a);
            let g = new ScalerParams(1, b, c, this.qd.cg);
            g.c = this.getEffectiveViewport1(a);
            let h = this.qc;
            let i = this.qd;
            let j = this.qm.count;
            let k;
            let xArr_ = this.qp.asArray();
            k = (xArr_.slice(0));
            let l;
            let yArr_ = this.qq.asArray();
            l = (yArr_.slice(0));
            let m = this.sb.asArray();
            let n = this.qm.asArray();
            let o = this.qn.asArray();
        ...
        sn() {
            ...
            if (this.r9 == null || this.r9.brushes == null || this.r9.brushes.count == 0) {
                ...
                for (let c of fromEnum(this.r9.brushes)) {
                    b.brushes.add(c);
                }
            }
            if (this.r9 != null) {
        ...
        fd(a, b, c) {
            return super.fd(a, b, c) && this.r6 != null && this.qp != null && this.qq != null && this.qm != null && this.qn != null && this.qo != null && this.qp.count > 0 && this.qq.count > 0 && this.qm.count > 0 && this.qn.count > 0 && this.qo.count > 0;
        }
        au(a, b) {
            let c = this.r7.b7(a, b);
            if (c != null) {
    ...
    ScatterContourSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ScatterContourSeries, 'raisePropertyChanged', ['ActualFillScale:r8:sp', [ValueBrushScale.$, null], 'FillScale:r9:sq', [ValueBrushScale.$, null], 'ValueMemberAsLegendLabel:sf:sr', [2, null], 'ValueMemberAsLegendUnit:sh:ss', [2, null], 'ValueMemberPath:sj:st', [2, null]]);
    ...
    class ScatterContourSeriesView extends SeriesView {
        ...
        b2(a, b) {
            ...
            for (let e = 0; e < b.length; e++) {
                ...
                if (d != null) {
                    let m = d.getBrushByValue(f, this.by.sb);
                    if (m == null) {
                        m = this.e.o5;
                    }
                    this.b0.add(m);
                ...
                if (e != null) {
                    for (let f = 0; f < e.c.count; f++) {
                        ...
                        for (let i = 0; i < g._segments.count; i++) {
                            ...
                            if (j != null) {
                                let k = this.by.fy / 2 + this.by.gc(b);
