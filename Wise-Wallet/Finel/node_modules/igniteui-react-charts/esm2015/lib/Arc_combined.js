...
export let Arc = /*@__PURE__*/ (() => {
    class Arc extends PieChartBase {
        ...
        ji(a) {
            for (let b of fromEnum(this.je.g)) {
                if (b.b == a) {
                    return b;
                }
            }
        ...
        gx() {
            ...
            for (let b of fromEnum(this.bw.a)) {
                let c = new ContentControl();
                let d = this.dn(b);
                let e = b.b0;
                let f = b.isOthersSlice ? this.e5 : (this.br != null && this.br.count > 0) ? this.br.item(this.cn._inner[b.a5]) : null;
                f = (f == null && this.bq.count > 0) ? this.bq.item(this.cn._inner[b.a5]) : f;
                c.content = ((() => {
                    let $ret = new PieSliceDataContext();
                    $ret.series = this.jh.c;
                    $ret.slice = b;
                    $ret.item = b.dataContext;
                    $ret.itemBrush = e;
                    $ret.legendLabel = f != null ? f.toString() : null;
                    $ret.itemLabel = d != null ? d.toString() : null;
                    $ret.percentValue = this.c8(b);
    ...
    Arc.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, Arc, 'gt', ['EndAngle:jl:jo', [1, 360]]);
    return Arc;
})();
/**
 * @hidden
...
export let ArcItem = /*@__PURE__*/ (() => {
    class ArcItem extends Base {
        ...
        o(a, b) {
            ...
            let o = e.count;
            let p = f.count > 0;
            let q = PieChartBase.dg(a);
            let r = PieChartBase.dg(a);
            if (p) {
                o++;
            }
            for (let s = 0; s < o; s++) {
