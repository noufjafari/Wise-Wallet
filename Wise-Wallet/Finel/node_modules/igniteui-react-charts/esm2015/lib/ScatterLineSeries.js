...
export let ScatterLineSeries = /*@__PURE__*/ (() => {
    class ScatterLineSeries extends ScatterBase {
        ...
        constructor() {
            ...
            this.sb = new ScatterFrame();
            this.sd = new ScatterFrame();
            this.r9 = new ScatterFrame();
            let a = (b, c, d) => {
                let e = this.cl.indexOf(b.a);
                if (e == -1 || e == 0) {
                    return b;
                }
                let f = this.cl.item(e - 1);
                let g;
        ...
        ua(a, b) {
            ...
            let f = this.fx * this.fx;
            let g = 0;
            if (this.sl != null) {
                g = this.sl.count;
            }
            if (this.sm != null) {
                g = Math.min(this.sm.count, g);
            }
            let h = new ScalerParams(0, c, d, this.r5.d, e);
            let i = ((() => {
                let $ret = new ScalerParams(0, c, d, this.r5.e, e);
                $ret.b = this.gg();
                return $ret;
            })());
        ...
        ul(a, b) {
            ...
            d = RectUtil.t(d, this.fy, this.fy);
            this.ue(a, new Clipper(0, d, false));
            let e = typeCast(ScatterLineSeriesView.$, b);
            this.si.az(this, this.sz(), runOn(this, this.rt));
            let f = false;
            let g = this.si.b;
            if (g != null) {
                f = true;
            ...
            if (f) {
                this.t6(-1, this.sl.count, b.q);
            }
            this.si.ad(e.dg, true, false, true, false);
            this.vm(e.dg, a.m.count, (h) => a.m._inner[h].x, (h) => a.m._inner[h].y, this.vg, this.fx);
        }
        vm(a, b, c, d, e, f) {
            ...
            for (let j = 0; j < b; j++) {
                if (isNaN_(c(j)) || isNaN_(d(j))) {
                    ...
                    if (k > 0) {
                        ...
                        this.vl(h._inner[h.count - 1]._points, i, j - 1, c, d, f);
                    }
                    i = j + 1;
                }
            }
            ...
            this.vl(h._inner[h.count - 1]._points, i, b - 1, c, d, f);
        ...
        vl(a, b, c, d, e, f) {
            if (c > -1) {
                let g = !isNaN_(this.gy) ? f : 1;
                let h = this.vi(new List$1(Number_$type, 0), d, e, b, c, g);
                let i;
    ...
    ScatterLineSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ScatterLineSeries, 'raisePropertyChanged', ['UnknownValuePlotting:vg:vn', [UnknownValuePlotting_$type, /*@__PURE__*/ enumGetBox(UnknownValuePlotting_$type, 1)]]);
