...
export let PolarAxes = /*@__PURE__*/ (() => {
    class PolarAxes extends Base {
        ...
        e(a, b, c, d, e, f, g, h) {
            ...
            let n;
            let o;
            let p = Math.min(this.a.lw, this.a.lv);
            let q = Math.max(this.a.lw, this.a.lv);
            let r = Math.min(this.b.lv, this.b.lw);
            let s = Math.max(this.b.lv, this.b.lw);
            let t = this.a.li;
            let u = this.a.cg;
            let v = this.b.li;
            let w = this.b.cg;
