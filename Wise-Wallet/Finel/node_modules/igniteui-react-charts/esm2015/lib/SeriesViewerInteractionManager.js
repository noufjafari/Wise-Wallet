...
export let SeriesViewerInteractionManager = /*@__PURE__*/ (() => {
    class SeriesViewerInteractionManager extends Base {
        ...
        f$ao(a, b) {
            ...
            e = a.cu.e();
            let f;
            let g = ((() => { let h = a.cu.f(b, false, f, false); f = h.p2; return h.ret; })());
            if (g != e) {
                if (e != null && e.a7.a$c) {
                    e.a7.a$z(e, b, null, null, false);
                }
            }
            c = f;
            if (a != null) {
        ...
        f$an(a) {
            ...
            a.md(c);
            let k = a.cl == 0 && !a.eb && (a.dz || f) && !g && !h;
            let l = a.tp;
            if (k && !isNaN_(b.x) && !l.isEmpty) {
                let m = l.width * (b.x - a.ta.left) / a.ta.width;
            ...
            if (k && !isNaN_(b.y) && !l.isEmpty) {
                let n = l.height * (b.y - a.ta.top) / a.ta.height;
        ...
        f$q(a, b) {
            if (b.x >= 0 && b.y >= 0 && b.x <= a.tp.width && b.y <= a.tp.height) {
                this.ae(a, b);
            }
            else {
                a.l0();
        ...
        ac(a) {
            ...
            b.cf();
            b.ch();
            a.lr({ $type: Point_$type, x: NaN, y: NaN });
            b.cg();
            b.cl();
            b.ck();
        }
        ...
        f$ai(a, b, c, d, e) {
            ...
            let k = g.width;
            let l = g.height;
            let m = this.ai.width / this.q;
            let n = this.ai.height / this.r;
            if (m > 1) {
                m = 1;
            }
            if (n > 1) {
        ...
        af(a) {
            if (this.f == null) {
                this.f = new TileZoomManager(a, true, a.ht);
                this.f.h = !a.e5;
            }
            a.d8 = true;
            a.n2();
        ...
        f$m(a, b, c) {
            ...
            let f = false;
            let g = new Rect(2, { $type: Point_$type, x: this.aj.x, y: this.aj.y }, b);
            ...
            if (this.n(a)) {
                let l = j;
                let m = k.left + k.width * (this.aj.x - b.x) / l.width;
                let n = k.top + k.height * (this.aj.y - b.y) / l.height;
        ...
        f$l(a, b, c, d) {
            ...
            if (!this.i) {
                let i = false;
                let j = new Rect(2, { $type: Point_$type, x: this.aj.x, y: this.aj.y }, b);
                ...
                if (a.cl == 2) {
                    let k = g;
                    let l = h.left + h.width * (this.aj.x - b.x) / k.width;
                    let m = h.top + h.height * (this.aj.y - b.y) / k.height;
                    a.pi(new Rect(0, l, m, h.width, h.height), true);
                }
            }
            let n = false;
            let o = new Rect(2, { $type: Point_$type, x: this.ak.x, y: this.ak.y }, b);
        ...
        f$f(a, b, c) {
            let d = a.cu;
            let e = a.ta;
            let f = e.left + e.width * b.x / a.tp.width;
            let g = e.top + e.height * b.y / a.tp.height;
            ...
            a.ny();
            this.x(a, 1000);
            a.pi(new Rect(0, i, l, k - i, j - l), true);
            return a.eq();
        }
        x(a, b) {
            a.cu.bz(b);
        ...
        f$d(a, b, c, d, e, f, g) {
            ...
            if (h && c != null) {
                ...
                let p = m;
                if (a.gd != 1) {
                    o = truncate(Math.round(d.x * a.gd));
                    p = truncate(Math.round(d.y * a.gd));
                }
                let q = c.a(o, p);
        ...
        f$g(a, b) {
            ...
            if (c >= a.tp.left && d >= a.tp.top && c <= a.tp.left + a.tp.width && d <= a.tp.top + a.tp.height) {
                let e = a.cn;
        ...
        f$w(a, b, c, d, e, f) {
            ...
            g.position = d;
            if (a.cl == 2 || a.cl == 1 || a.e4 || (a.cn != null && a.cn.isPinching)) {
                if (this.d != null) {
                    this.d.a7.a$z(this.d, g.position, this.a, g, f);
                    this.d = null;
                }
                return;
            }
            let h = null;
            let i = ((() => { let j = this.f$d(a, b, c, d, !e, h, f); h = j.p5; return j.ret; })());
            this.a = h;
            let j = this.c(i);
            if (i != null) {
                let k = false;
                ...
                if (k) {
                    if (l) {
                        if (this.d != null) {
                            j = this.c(this.d);
                            this.d.a7.a$z(this.d, g.position, h, g, f);
                            if (j != null) {
                                j.a7.a$z(j, g.position, h, g, f);
                            }
                        }
                    }
                    this.d = i;
                    i.l1(g.position, h, g, f);
                    if (j != null) {
                        j.l1(g.position, h, g, f);
                    }
                }
                else {
                    this.d = i;
                    i.a7.a$ab(i, g.position, h, g, f);
                    if (j != null) {
                        j.a7.a$ab(j, g.position, h, g, f);
                    }
                }
            }
            else {
                ...
                for (let m = 0; m < a.series.count; m++) {
                    ...
                    if (n.a7.a$b) {
                        j = this.c(n);
                        n.a7.a$z(n, g.position, n.a7.a$p, g, f);
                        if (j != null) {
                            j.a7.a$z(j, g.position, n.a7.a$p, g, f);
                        }
                    }
                }
            }
        ...
        f$v(a, b) {
            if (this.d != null) {
                ...
                d.position = b;
                this.d.a7.a$z(this.d, d.position, null, d, false);
                if (c != null) {
                    c.a7.a$z(c, d.position, null, d, false);
                }
                this.d = null;
            }
            a.nc(b, a.cl != 0 || a.ev);
        ...
        f$u(a, b, c) {
            if (this.d != null) {
                ...
                d.position = c;
                if (b.al) {
                    this.d.a7.a$ac(this.d, d.position, this.a, d);
                }
                else {
                    this.d.a7.a$w(this.d, d.position, this.a, d);
                }
            }
        }
        f$x(a, b, c) {
            let d;
            let e = (this.d != null) ? this.d : ((() => { let f = a.cu.f(c, false, d, false); d = f.p2; return f.ret; })());
            if (e != null) {
                let f = new MouseButtonEventArgs();
                f.position = c;
                if (b.al) {
                    e.a7.a$ad(e, f.position, this.a, f);
                }
                else {
                    e.a7.a$aa(e, f.position, this.a, f);
                }
            }
        }
        f$t(a, b, c) {
