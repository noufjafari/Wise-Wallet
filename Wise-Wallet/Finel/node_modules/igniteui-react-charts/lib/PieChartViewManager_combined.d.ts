...
export declare abstract class PieChartBase extends Control implements INotifyPropertyChanged, ILegendOwner, ILegendSeries, ILegendTemplateProvider {
    ...
    bl: FastItemsSource;
    private bp;
    get bu(): IFastItemColumn$1<number>;
    set bu(a: IFastItemColumn$1<number>);
    dl: number;
    dd: number;
    di: number;
    cn: List$1<number>;
    ...
    static readonly ho: DependencyProperty;
    get c9(): number;
    set c9(a: number);
    fu: string;
    ei: string;
    ...
    static readonly hz: DependencyProperty;
    get hb(): DataTemplate;
    set hb(a: DataTemplate);
    cd: boolean;
    ce: boolean;
    cg: boolean;
    ch: boolean;
    ...
    get c1(): number;
    set c1(a: number);
    bj: SliceSelectionMode;
    get selectedItem(): any;
    set selectedItem(a: any);
    static readonly im: DependencyProperty;
    ...
    gc(a: any, b: LabelClickEventArgs): void;
    selectedItemChanging: (sender: any, e: SelectedItemChangingEventArgs) => void;
    ge(a: any, b: SelectedItemChangingEventArgs): void;
    selectedItemsChanging: (sender: any, e: SelectedItemsChangingEventArgs) => void;
    gh(a: any, b: SelectedItemsChangingEventArgs): void;
    selectedItemChanged: (sender: any, e: SelectedItemChangedEventArgs) => void;
    gd(a: any, b: SelectedItemChangedEventArgs): void;
    selectedItemsChanged: (sender: any, e: SelectedItemsChangedEventArgs) => void;
    gf(a: any, b: SelectedItemsChangedEventArgs): void;
    sliceClick: (sender: any, e: SliceClickEventArgs) => void;
    gj(a: any, b: SliceClickEventArgs): void;
    bw: Pool$1<Slice>;
    bv: Pool$1<PieLabel>;
    fy(a: Slice, b: boolean): void;
    g1(a: Slice, b: boolean): void;
    g2(a: Slice): void;
    dn(a: Slice): any;
    i7(a: Slice, b: LabelsPosition): Rect;
    b9(a: PieLabel, b: Point): boolean;
    static dg(a: number): number;
    private cc;
    private static c5;
    static g7(a: List$1<PieLabel>): void;
    gz(a: List$1<PieLabel>): void;
    protected fw(a: FastItemsSourceEventAction, b: number, c: number, d: string): void;
    gv(): void;
    go(): void;
    gq(): void;
    private fg;
    ...
    private static i4;
    gx(): void;
    bk(): PieChartVisualData;
    d3(): string;
    protected bs(a: string): IFastItemColumn$1<number>;
    protected bt(a: string): IFastItemColumn$1<any>;
    ap: BindingFormatter;
    as: BindingFormatter;
    aq: BindingFormatter;
    ar: BindingFormatter;
    protected gr(a: any, b: string, c: any, d: any): void;
    protected ao(a: BrushCollection): BrushCollection;
    protected i1(a: Brush): Brush;
    private ff;
    private fh;
    private co;
    protected cr(): IEnumerable;
    protected g0(a: NotifyCollectionChangedEventArgs): void;
    protected gg(a: NotifyCollectionChangedEventArgs): void;
    propertyChanged: (sender: any, e: PropertyChangedEventArgs) => void;
    propertyUpdated: (sender: any, e: PropertyUpdatedEventArgs) => void;
    protected gt(a: string, b: any, c: any): void;
    private ha;
    private g9;
    g5(a: Slice, b: MouseEventArgs): void;
    g6(a: Slice, b: MouseEventArgs, c: boolean): void;
    g4(a: Point): void;
    cf(a: Slice, b: MouseEventArgs): boolean;
    private dm;
    f0(a: any, b: any): void;
    ...
    private gl;
    private gm;
    f3(a: any, b: any, c: boolean): void;
    f2(a: any, b: any): void;
    f1(a: any, b: MouseEventArgs): void;
    gi(): void;
    provideContainer(a: any): void;
    ga(a: number, b: number): void;
    ...
    c8(a: Slice): number;
    f8(source_: any, a: number, b: any, c: any): void;
    f4(source_: any): void;
    private ci;
    static cj(a: any, b: any): boolean;
    f6(source_: any, a: number, b: any): void;
