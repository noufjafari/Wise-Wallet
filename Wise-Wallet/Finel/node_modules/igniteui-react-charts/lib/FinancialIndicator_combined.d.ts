...
export declare abstract class FinancialIndicator extends FinancialSeries implements ITrendLineSeries {
    ...
    tv: FinancialIndicatorView;
    constructor();
    t8(a: boolean): void;
    protected t0(a: Point, b: Point, c: boolean): boolean;
    ...
    tx: IndicatorDisplayType;
    protected get_tw(): IndicatorDisplayType;
    get tw(): IndicatorDisplayType;
    t3: number;
    ...
    protected tu: AxisRange;
    protected abstract ty(a: number, b: number): boolean;
    protected abstract t1(a: number, b: number): IList$1<string>;
