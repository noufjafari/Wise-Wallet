...
export declare class NumericAngleAxis extends NumericAxisBase implements IAngleScaler {
    ...
    a3(): AxisView;
    hr(a: AxisView): void;
    ng: NumericAngleAxisView;
    nj: PolarAxisRenderingManager;
    protected get_b8(): boolean;
    constructor();
    au(): AxisLabelPanelBase;
    private nn;
    ...
    protected hv(a: any, b: string, c: any, d: any): void;
    private ns;
    k1(): NumericAxisRenderingParameters;
    k0(a: Rect, b: Rect, c: Rect, d: Rect): NumericAxisRenderingParameters;
    getMinMaxAngle(a: Rect, b: number, c: number): {
        p1: number;
        p2: number;
    };
    protected h8(a: boolean): void;
    private nh;
    get ni(): NumericRadiusAxis;
    set ni(a: NumericRadiusAxis);
    aj(): Axis;
    nu(a: NumericRadiusAxis): void;
...
export declare class NumericRadiusAxis extends NumericAxisBase {
    ...
    kx(): NumericAxisRenderer;
    ei(a: number, b: ScalerParams): number;
    nu(a: number, b: boolean, c: boolean, d: number, e: number): number;
    nt(a: number): number;
    nv(a: number): number;
    el(a: number, b: ScalerParams): number;
    nx: number;
    ...
    private ny;
    ns(): number;
    m1(a: AxisRangeChangedEventArgs): void;
    protected h8(a: boolean): void;
    protected io(a: Rect, b: Rect): void;
    n1(a: GeometryGroup, b: Rect, c: Rect, d: Rect, e: Rect): void;
    protected get_a1(): AxisOrientation;
    get a1(): AxisOrientation;
    j4(a: number, b: Rect, c: Rect, d?: any, e?: any): Geometry;
    static $$p: string[];
