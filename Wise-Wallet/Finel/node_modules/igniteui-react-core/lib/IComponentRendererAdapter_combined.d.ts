...
export declare class TypeDescriptionContext extends Base {
    ...
    private i;
    private r;
    ab(a: Dictionary$2<string, string>): void;
    k(a: Dictionary$2<string, string>): boolean;
    ac(a: string, b: Dictionary$2<string, string>): void;
    ad(a: string, b: () => any): void;
    static aa(key_: string): string;
    static z(key_: string): string;
    a(): string[];
    b(a: string): string[];
    getMetadata(a: string, b: string): TypeDescriptionMetadata;
    v(a: string): any;
    ae(a: Description, b: string, c: TypeDescriptionMetadata, d: any): void;
    af(a: Description, b: string, c: TypeDescriptionMetadata, d: any): void;
    u(a: any[]): any;
    t(a: any[]): any;
    w(a: any[]): any;
    x(a: string, b: any): any;
    s(a: string, b: string, c: TypeDescriptionMetadata, d: boolean): any;
