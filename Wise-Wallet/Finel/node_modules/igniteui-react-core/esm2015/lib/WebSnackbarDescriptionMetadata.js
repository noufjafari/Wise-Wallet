...
export let WebSnackbarDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebSnackbarDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebSnackbarDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebSnackbar", () => new WebSnackbarDescription());
            a.ac("WebSnackbar", WebSnackbarDescriptionMetadata.a);
        }
    }
    WebSnackbarDescriptionMetadata.$t = /*@__PURE__*/ markType(WebSnackbarDescriptionMetadata, 'WebSnackbarDescriptionMetadata');
