...
export let WebComboDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebComboDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebComboDescriptionMetadata.a);
        ...
        static c(a) {
            ...
            a.item("Dir", "ExportedType:string:ComboDir");
            ...
            a.item("GroupSorting@names", "Asc;Desc");
        ...
        static d(a) {
            ...
            a.ad("WebCombo", () => new WebComboDescription());
            a.ac("WebCombo", WebComboDescriptionMetadata.a);
        }
    }
