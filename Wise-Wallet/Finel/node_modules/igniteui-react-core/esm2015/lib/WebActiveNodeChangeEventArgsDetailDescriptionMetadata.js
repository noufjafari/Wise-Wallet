...
export let WebActiveNodeChangeEventArgsDetailDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebActiveNodeChangeEventArgsDetailDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebActiveNodeChangeEventArgsDetailDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ad("WebActiveNodeChangeEventArgsDetail", () => new WebActiveNodeChangeEventArgsDetailDescription());
            a.ac("WebActiveNodeChangeEventArgsDetail", WebActiveNodeChangeEventArgsDetailDescriptionMetadata.a);
        }
    }
    WebActiveNodeChangeEventArgsDetailDescriptionMetadata.$t = /*@__PURE__*/ markType(WebActiveNodeChangeEventArgsDetailDescriptionMetadata, 'WebActiveNodeChangeEventArgsDetailDescriptionMetadata');
