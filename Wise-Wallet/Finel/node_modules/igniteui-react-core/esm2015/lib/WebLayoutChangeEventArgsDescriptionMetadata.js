...
export let WebLayoutChangeEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebLayoutChangeEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebLayoutChangeEventArgsDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebLayoutChangeEventArgs", () => new WebLayoutChangeEventArgsDescription());
            a.ac("WebLayoutChangeEventArgs", WebLayoutChangeEventArgsDescriptionMetadata.a);
        }
    }
    WebLayoutChangeEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebLayoutChangeEventArgsDescriptionMetadata, 'WebLayoutChangeEventArgsDescriptionMetadata');
