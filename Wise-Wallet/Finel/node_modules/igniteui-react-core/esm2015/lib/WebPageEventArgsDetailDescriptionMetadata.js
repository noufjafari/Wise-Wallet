...
export let WebPageEventArgsDetailDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebPageEventArgsDetailDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebPageEventArgsDetailDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ad("WebPageEventArgsDetail", () => new WebPageEventArgsDetailDescription());
            a.ac("WebPageEventArgsDetail", WebPageEventArgsDetailDescriptionMetadata.a);
        }
    }
    WebPageEventArgsDetailDescriptionMetadata.$t = /*@__PURE__*/ markType(WebPageEventArgsDetailDescriptionMetadata, 'WebPageEventArgsDetailDescriptionMetadata');
