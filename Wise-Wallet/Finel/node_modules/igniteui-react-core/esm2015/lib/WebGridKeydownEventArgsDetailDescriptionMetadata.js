...
export let WebGridKeydownEventArgsDetailDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebGridKeydownEventArgsDetailDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebGridKeydownEventArgsDetailDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ad("WebGridKeydownEventArgsDetail", () => new WebGridKeydownEventArgsDetailDescription());
            a.ac("WebGridKeydownEventArgsDetail", WebGridKeydownEventArgsDetailDescriptionMetadata.a);
        }
    }
    WebGridKeydownEventArgsDetailDescriptionMetadata.$t = /*@__PURE__*/ markType(WebGridKeydownEventArgsDetailDescriptionMetadata, 'WebGridKeydownEventArgsDetailDescriptionMetadata');
