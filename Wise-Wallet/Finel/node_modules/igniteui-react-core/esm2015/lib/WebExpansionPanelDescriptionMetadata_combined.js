...
export let WebExpansionPanelDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebExpansionPanelDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebExpansionPanelDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebExpansionPanel", () => new WebExpansionPanelDescription());
            a.ac("WebExpansionPanel", WebExpansionPanelDescriptionMetadata.a);
        }
    }
    WebExpansionPanelDescriptionMetadata.$t = /*@__PURE__*/ markType(WebExpansionPanelDescriptionMetadata, 'WebExpansionPanelDescriptionMetadata');
...
export let WebExpansionPanelComponentEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebExpansionPanelComponentEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebExpansionPanelComponentEventArgsDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebExpansionPanelComponentEventArgs", () => new WebExpansionPanelComponentEventArgsDescription());
            a.ac("WebExpansionPanelComponentEventArgs", WebExpansionPanelComponentEventArgsDescriptionMetadata.a);
        }
    }
    WebExpansionPanelComponentEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebExpansionPanelComponentEventArgsDescriptionMetadata, 'WebExpansionPanelComponentEventArgsDescriptionMetadata');
