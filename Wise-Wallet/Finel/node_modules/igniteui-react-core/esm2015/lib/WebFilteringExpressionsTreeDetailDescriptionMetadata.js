...
export let WebFilteringExpressionsTreeDetailDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebFilteringExpressionsTreeDetailDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebFilteringExpressionsTreeDetailDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebFilteringExpressionsTreeDetail", () => new WebFilteringExpressionsTreeDetailDescription());
            a.ac("WebFilteringExpressionsTreeDetail", WebFilteringExpressionsTreeDetailDescriptionMetadata.a);
        }
    }
    WebFilteringExpressionsTreeDetailDescriptionMetadata.$t = /*@__PURE__*/ markType(WebFilteringExpressionsTreeDetailDescriptionMetadata, 'WebFilteringExpressionsTreeDetailDescriptionMetadata');
