...
export let WebLinearProgressDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebLinearProgressDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebLinearProgressDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ad("WebLinearProgress", () => new WebLinearProgressDescription());
            a.ac("WebLinearProgress", WebLinearProgressDescriptionMetadata.a);
        }
    }
    WebLinearProgressDescriptionMetadata.$t = /*@__PURE__*/ markType(WebLinearProgressDescriptionMetadata, 'WebLinearProgressDescriptionMetadata');
