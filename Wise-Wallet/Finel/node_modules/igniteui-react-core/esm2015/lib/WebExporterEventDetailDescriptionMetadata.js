...
export let WebExporterEventDetailDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebExporterEventDetailDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(WebExporterEventDetailDescriptionMetadata.a)) {
                return;
            }
            a.ab(WebExporterEventDetailDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebExporterEventDetail", () => new WebExporterEventDetailDescription());
            a.ac("WebExporterEventDetail", WebExporterEventDetailDescriptionMetadata.a);
        }
    }
    WebExporterEventDetailDescriptionMetadata.$t = /*@__PURE__*/ markType(WebExporterEventDetailDescriptionMetadata, 'WebExporterEventDetailDescriptionMetadata');
