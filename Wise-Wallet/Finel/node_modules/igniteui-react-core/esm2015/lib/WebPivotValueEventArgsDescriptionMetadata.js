...
export let WebPivotValueEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebPivotValueEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(WebPivotValueEventArgsDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebPivotValueEventArgs", () => new WebPivotValueEventArgsDescription());
            a.ac("WebPivotValueEventArgs", WebPivotValueEventArgsDescriptionMetadata.a);
        }
    }
    WebPivotValueEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebPivotValueEventArgsDescriptionMetadata, 'WebPivotValueEventArgsDescriptionMetadata');
