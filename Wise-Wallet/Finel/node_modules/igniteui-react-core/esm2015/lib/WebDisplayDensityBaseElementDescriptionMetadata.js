...
export let WebDisplayDensityBaseElementDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebDisplayDensityBaseElementDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(WebDisplayDensityBaseElementDescriptionMetadata.a)) {
                return;
            }
            a.ab(WebDisplayDensityBaseElementDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebDisplayDensityBaseElement", () => new WebDisplayDensityBaseElementDescription());
            a.ac("WebDisplayDensityBaseElement", WebDisplayDensityBaseElementDescriptionMetadata.a);
        }
    }
    WebDisplayDensityBaseElementDescriptionMetadata.$t = /*@__PURE__*/ markType(WebDisplayDensityBaseElementDescriptionMetadata, 'WebDisplayDensityBaseElementDescriptionMetadata');
