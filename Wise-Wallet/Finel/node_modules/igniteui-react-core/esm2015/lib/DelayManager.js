    ...
    class DelayManager extends Base {
        ...
        constructor(a, ..._rest) {
            ...
            switch (a) {
                case 0:
                    {
                        this.c = new FastIterationDictionary$2(Delegate_$type, DelayManager_CallbackSettings.$, 0);
        ...
        f(a, b) {
            ...
            if (this.c.d(a)) {
                ...
                let c = new DelayManager_CallbackSettings();
                c.a = this.e++;
        ...
        h(a) {
            if (this.c.d(a)) {
                let b = this.c.item(a);
                let c = this.a.getCurrentRelativeTime();
                let d = c - b.c;
                if (d >= b.b) {
                    a();
                    this.c.f(a);
