 ...
 * @hidden
 */
export let WebToggleDirectiveDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebToggleDirectiveDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.k(WebToggleDirectiveDescriptionMetadata.a)) {
                return;
            }
            a.ab(WebToggleDirectiveDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.ad("WebToggleDirective", () => new WebToggleDirectiveDescription());
            a.ac("WebToggleDirective", WebToggleDirectiveDescriptionMetadata.a);
        }
    }
    WebToggleDirectiveDescriptionMetadata.$t = /*@__PURE__*/ markType(WebToggleDirectiveDescriptionMetadata, 'WebToggleDirectiveDescriptionMetadata');
