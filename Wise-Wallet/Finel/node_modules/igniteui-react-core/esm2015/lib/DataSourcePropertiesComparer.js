...
export let DataSourcePropertiesComparer = /*@__PURE__*/ (() => {
    class DataSourcePropertiesComparer extends Base {
        constructor(a, b, c, d) {
            ...
            if (a != null) {
                ...
                for (let g = 0; g < a.length; g++) {
                    ...
                    for (let k = 0; k < j.length; k++) {
                        ...
                        let m = false;
                        if (h != null) {
                            for (let n = 0; n < h.propertyNames.length; n++) {
            ...
            let o = new Dictionary$2(String_$type, DataSourceSchemaPropertyType_$type, 0);
            for (let p = 0; p < this.f.propertyNames.length; p++) {
                o.item(this.f.propertyNames[p], this.f.propertyTypes[p]);
            }
            if (this.b != null) {
                for (let q = 0; q < this.b.length; q++) {
                    if (o.containsKey(this.b[q])) {
                        this.d[q] = o.item(this.b[q]);
                    }
                    else {
                        this.d[q] = d.resolveSchemaPropertyType(this.b[q]);
                    }
                }
            }
        }
