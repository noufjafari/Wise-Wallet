...
export let ToolActionLabelInfoDescriptionMetadata = /*@__PURE__*/ (() => {
    class ToolActionLabelInfoDescriptionMetadata extends Base {
        static b(a) {
            ...
            a.ab(ToolActionLabelInfoDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.ad("ToolActionLabelInfo", () => new ToolActionLabelInfoDescription());
            a.ac("ToolActionLabelInfo", ToolActionLabelInfoDescriptionMetadata.a);
        }
    }
    ToolActionLabelInfoDescriptionMetadata.$t = /*@__PURE__*/ markType(ToolActionLabelInfoDescriptionMetadata, 'ToolActionLabelInfoDescriptionMetadata');
