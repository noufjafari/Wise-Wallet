...
var BrushUtil = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BrushUtil.n = function (a, b) {
        ...
        if (a.isGradient) {
            ...
            for (var d = 0; d < c.gradientStops.length; d++) {
                var e = c.gradientStops[d];
                e.color = ColorUtil.w(e.color, b);
            }
            return c;
        }
        else {
            var f_2 = ColorUtil.w(a.color, b);
            return ((function () {
                var $ret = new Brush();
                $ret.color = f_2;
                return $ret;
    ...
    BrushUtil.m = function (a, b) {
        ...
        if (a.isGradient) {
            ...
            for (var d = 0; d < c.gradientStops.length; d++) {
                var e = c.gradientStops[d];
                e.color = BrushUtil.t(e.color, b);
            }
            return c;
        }
        else {
            var f_3 = BrushUtil.t(a.color, b);
            return ((function () {
                var $ret = new Brush();
                $ret.color = f_3;
                return $ret;
    ...
    BrushUtil.k = function (a, b, c, d) {
        ...
        if (f != null && g != null) {
            return BrushUtil.r(f, b, g, d);
        }
        if (f != null && i != null) {
            return BrushUtil.q(f, b, i, d);
        }
        if (h != null && g != null) {
            return BrushUtil.q(g, 1 - b, h, d);
        }
        if (h != null && i != null) {
            return BrushUtil.o(h, b, i, d);
        }
        return e;
    };
