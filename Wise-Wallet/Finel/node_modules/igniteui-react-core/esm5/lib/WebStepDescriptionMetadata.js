...
var WebStepDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WebStepDescriptionMetadata.b = function (a) {
        ...
        a.ab(WebStepDescriptionMetadata.a);
    };
    WebStepDescriptionMetadata.c = function (a) {
        ...
        a.item("PreviousComplete", "Boolean");
        a.item("StepType", "ExportedType:string:StepStepType");
        a.item("StepType@stringUnion", "WebComponents;React");
        a.item("StepType@names", "Indicator;Title;Full");
        a.item("TitlePosition", "ExportedType:string:StepTitlePosition");
        a.item("TitlePosition@stringUnion", "WebComponents;React");
        a.item("TitlePosition@names", "Top;Bottom;Start;End");
        a.item("Orientation", "ExportedType:string:StepOrientation");
        ...
        a.item("LinearDisabled", "Boolean");
        a.item("Visited", "Boolean");
    };
    WebStepDescriptionMetadata.d = function (a) {
        WebStepDescriptionMetadata.b(a);
        a.ad("WebStep", function () { return new WebStepDescription(); });
        a.ac("WebStep", WebStepDescriptionMetadata.a);
    };
