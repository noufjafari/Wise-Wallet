...
import { DelayManager_CallbackSettings } from "./DelayManager_CallbackSettings";
/**
 * @hidden
 */
var DelayManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DelayManager(a) {
        ...
        switch (a) {
            case 0:
                {
                    _this.c = new FastIterationDictionary$2(Delegate_$type, DelayManager_CallbackSettings.$, 0);
    ...
    DelayManager.prototype.f = function (a, b) {
        ...
        if (this.c.d(a)) {
            ...
            var c = new DelayManager_CallbackSettings();
            c.a = this.e++;
    ...
    DelayManager.prototype.h = function (a) {
        ...
        if (this.c.d(a)) {
            var b = this.c.item(a);
            var c = this.a.getCurrentRelativeTime();
            var d = c - b.c;
            if (d >= b.b) {
                a();
                this.c.f(a);
