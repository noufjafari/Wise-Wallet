...
var CodeGeneratingComponentRendererHandlerEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
                ...
                if (g != null) {
                    if (g.isJson) {
                        ...
                        if (i.g("handler")) {
                            ...
                            var o = i.item("handler").value;
                            o = this.q(o);
                            if (!stringContains(o, "OMIT HANDLER")) {
                                var p = stringReplace(o, "\r\n", "\n").split('\n');
                                var q = 0x7FFFFFFF;
                                var r = "";
                                for (var s = 0; s < this.o.indentSpaces; s++) {
                                    r += " ";
                                }
    ...
    CodeGeneratingComponentRendererHandlerEmitter.prototype.q = function (a) {
        return a;
    };
