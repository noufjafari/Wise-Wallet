...
var AbsolutePanelBridge = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AbsolutePanelBridge.prototype.getX = function (a, b) {
        var c = b.al.getStyleProperty("left");
        stringReplace(c, "px", "");
        var d = parseFloat(c);
        return d;
    };
    AbsolutePanelBridge.prototype.getY = function (a, b) {
        var c = b.al.getStyleProperty("top");
        stringReplace(c, "px", "");
        var d = parseFloat(c);
        return d;
    };
    ...
    AbsolutePanelBridge.prototype.setX = function (a, b, c) {
        b.al.setStyleProperty("position", "absolute");
        b.al.setStyleProperty("left", c.toString() + "px");
    };
    AbsolutePanelBridge.prototype.setY = function (a, b, c) {
        b.al.setStyleProperty("position", "absolute");
        b.al.setStyleProperty("top", c.toString() + "px");
    };
